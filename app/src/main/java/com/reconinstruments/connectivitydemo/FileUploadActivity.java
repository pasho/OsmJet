    ...
    private class UploadFileTask extends AsyncTask<String, Void, Boolean>
    {
        ...
        protected Boolean doInBackground(String... urls)
        {
            ...
            try
            {
                ...
                //Http Post Request
                HUDHttpRequest request = new HUDHttpRequest(HUDHttpRequest.RequestMethod.POST, new URL(mUrl), headers, mData);
                ...
                if (response.hasBody())
                {
                    ...
                    else { mComment = "Error uploading data"; }
                }
            }
            catch (Exception e)
            {
